...
const isJsonRpcId = (id: unknown): id is JsonRpcId =>
 ...
 */
const errorId = (jsonRpcRequest: JsonRpcRequest): JsonRpcId => {
...
const jsonRpcShapeError = (jsonRpcRequest: JsonRpcRequest): Response | null => {
